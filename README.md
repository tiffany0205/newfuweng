...
基于 PHP 8.2、Laravel 12 和 SQLite 实现的 36 格大富翁活动。V2 包含用户登录注册、连续签到、每日/每周任务、地标图鉴、圈数与收集宝箱、邀请中心、道具背包、成就徽章、棋子皮肤、奖池播报、领奖中心、多维排行榜、消息中心、玩法 FAQ 及运营后台。
